...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.1
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['xinit'] - matrix of size [5x1]
       PARAMS['x0'] - matrix of size [70x1]
       PARAMS['all_parameters'] - matrix of size [20x1]
...
('x0', ctypes.c_double * 70),
('all_parameters', ctypes.c_double * 20),
...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.1
 ...
 See also COPYING
    ...
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.FORCESNLPsolver_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp)  )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.FORCESNLPsolver_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None )
            else:
                exitflag = _lib.FORCESNLPsolver_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp )
            libc.fclose(fp)
